...
namespace SharpMap.Converters.WellKnownText.IO
{
	...
	{	
		...
		public double GetNumericValue()
		{
            ...
            throw new InvalidDataException(String.Format(System.Globalization.CultureInfo.InvariantCulture.NumberFormat, "The token '{0}' is not a number at line {1} column {2}.", 
