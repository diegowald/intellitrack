...
namespace SharpMap.CoordinateSystems.Projections
{
	...
	internal abstract class MapProjection : MathTransform, IProjection
	{
		...
		static protected double LongitudeToRadians( double x, bool edge) 
		{
			...
			throw new ArgumentOutOfRangeException("x", x.ToString(System.Globalization.CultureInfo.InvariantCulture) + " not a valid longitude in degrees.");
		}
		...
		static protected double LatitudeToRadians(double y, bool edge)
		{
			...
			throw new ArgumentOutOfRangeException("y", y.ToString(System.Globalization.CultureInfo.InvariantCulture) + " not a valid latitude in degrees.");
		}
