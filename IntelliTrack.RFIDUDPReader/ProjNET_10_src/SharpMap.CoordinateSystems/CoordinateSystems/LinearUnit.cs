	...
	public class LinearUnit : Info, ILinearUnit
	{
		...
		public override string WKT
		{
			get
			{
				...
				sb.AppendFormat(System.Globalization.CultureInfo.InvariantCulture.NumberFormat, "UNIT[\"{0}\", {1}", Name, MetersPerUnit);
		...
		public override string XML
		{
			get
			{
				return String.Format(System.Globalization.CultureInfo.InvariantCulture.NumberFormat, "<CS_LinearUnit MetersPerUnit=\"{0}\">{1}</CS_LinearUnit>", MetersPerUnit, InfoXml);
			}
		}
