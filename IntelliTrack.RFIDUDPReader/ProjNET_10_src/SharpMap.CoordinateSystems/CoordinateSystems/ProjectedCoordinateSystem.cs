...
/*
		...
		public override string WKT
		{
			get
			{
				...
				for(int i=0;i<Projection.NumParameters;i++)
					sb.AppendFormat(System.Globalization.CultureInfo.InvariantCulture.NumberFormat, ", {0}", Projection.GetParameter(i).WKT);
		...
		public override string XML
		{
			...
			{
				StringBuilder sb = new StringBuilder();
				sb.AppendFormat(System.Globalization.CultureInfo.InvariantCulture.NumberFormat,
