	...
	public class AngularUnit : Info, IAngularUnit
	{
		...
		public override string WKT
		{
			get
			{
				...
				sb.AppendFormat(System.Globalization.CultureInfo.InvariantCulture.NumberFormat,"UNIT[\"{0}\", {1}", Name, RadiansPerUnit);
		...
		public override string XML
		{
			get
			{
                return String.Format(System.Globalization.CultureInfo.InvariantCulture.NumberFormat, "<CS_AngularUnit RadiansPerUnit=\"{0}\">{1}</CS_AngularUnit>", RadiansPerUnit, InfoXml);
			}
		}
