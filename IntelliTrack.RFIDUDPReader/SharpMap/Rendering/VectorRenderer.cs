...
namespace SharpMap.Rendering
{
    ...
    public class VectorRenderer
    {
        ...
        /// <param name="text">Text to render</param>
        /// <param name="map">Map reference</param>
        public static void DrawHtmlLabel(System.Drawing.Graphics g, System.Drawing.PointF LabelPoint, System.Drawing.PointF Offset, string text, SharpMap.Map map)
        {
          /*
          LabelPoint.X += Offset.X; LabelPoint.Y += Offset.Y; //add label offset

          System.Drawing.Html.HtmlRenderer.Render(g, text, LabelPoint, 40); //Ver 40 por un valor mas coherente
           */

          //Create the InitialContainer
          System.Drawing.Html.InitialContainer c = new System.Drawing.Html.InitialContainer(text);
          //Give bounds to the container
          c.SetBounds(new System.Drawing.Rectangle(
            new System.Drawing.Point(
              (int)System.Math.Floor(LabelPoint.X), 
              (int)System.Math.Floor(LabelPoint.Y)), 
