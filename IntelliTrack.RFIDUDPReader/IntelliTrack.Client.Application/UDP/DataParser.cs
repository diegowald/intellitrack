...
namespace IntelliTrack.Client.Application.UDP
{
  public class DataParser
  {
    ...
    private System.Collections.Generic.Dictionary<string, string> ParsedData_;
    public bool ParseData(string rawData, ref System.Collections.Generic.Dictionary<string, string> ParsedData)
    {
      dataPacket = rawData;
      if (ParseData())
      {
    ...
    private bool ParsePRAVEData(string[] words)
    {
      ...
      string fieldname;
      ParsedData_ = new Dictionary<string, string>();
    ...
    private bool VerifyCheckSum()
    {
      try
      {
        ...
        {
          byte ChecksumData = Hex2Dec(ParsedData_["Checksum"].Replace("*", ""), true);
